...
-- ═══════════════════════════════════════════════════════════════════════════════
--  PREMIUM GUI LIBRARY FOR ROBLOX (Delta Executor Ready)
--  Version: 2.0
--  Features: 10 Themes, 15+ Components, Icon Toggle, Smooth Animations
...
function IconToggle:Create(parent, theme, onToggle)
    ...
    local iconBtn = Utils:Create("ImageButton", {
        ...
        Image = "rbxassetid://7733965380", -- gear icon
